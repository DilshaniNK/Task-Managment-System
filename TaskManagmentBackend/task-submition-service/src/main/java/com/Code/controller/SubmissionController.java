...
import com.Code.service.SubmissionService;
...
public class SubmissionController {
    ...
    public ResponseEntity<List<Submission>> getAllSubmissionsByTaskId(
            ...
            @RequestHeader("Authorization") String jwt) throws Exception{
        UserDto user = userService.getUserProfile(jwt);
        List<Submission> submissions = submissionService.getAllSubmissionsByTaskId(taskId);
        return new ResponseEntity<>(submissions, HttpStatus.OK);
    }
    ...
    public ResponseEntity<Submission> acceptOrDeclineSubmission(
        ...
        Submission submission = submissionService.acceptDeclieneSubmission(id,status);
        return new ResponseEntity<>(submission, HttpStatus.OK);
    }
